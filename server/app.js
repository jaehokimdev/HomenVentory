...
app.post("/createbasedata", async (req, res) => {
  try {
    const baseUser = await User.findOne({ email: "admin@gmail.com" });
    const baseUser2 = await User.findOne({ email: "anne@gmail.com" });
    const baseUser3 = await User.findOne({ email: "barb@gmail.com" });
    const baseUser4 = await User.findOne({ email: "admin2@gmail.com" });
